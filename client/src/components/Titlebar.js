...
// import uoft_logo from "../uoft_logo.svg"
  ...
  function setRefresh(value) {
    ...
    return (
      <div class="flex flex-row m-6 shadow-md sm:rounded-lg">
        <div class="w-1/3 p-6">
          <img src="https://tspace.library.utoronto.ca/retrieve/d2a89b4a-bf56-46f9-b5b2-5e9b81f6ca8b" alt='Occupational Therapy and Occupational Science'/>
        </div>
        <div class="w-2/3 p-6">
